...
from app import db # Đảm bảo 'app' là đối tượng Flask của bạn và 'db' được khởi tạo từ nó
...
class Article(db.Model):
    ...
    content = db.Column(db.Text, nullable=False) # Nơi lưu nội dung HTML đầy đủ
    featured_image = db.Column(db.String(200), nullable=True)

    # THÊM TRƯỜNG NÀY: URL gốc của bài viết
    source_url = db.Column(db.String(500), unique=True, nullable=True) # unique để tránh trùng lặp
